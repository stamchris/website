...
<footer className="p-4 bg-white sm:p-6 ">
    <div className="md:flex md:justify-between">
        ...
        <div className="grid grid-cols-2 gap-8 ss:gap-6 ss:grid-cols-3">
            <div>
                <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase ">Επικοινωνια</h2>
            ...
            <div>
                <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase ">Ακολουθηστε Μας</h2>
                <ul className="text-gray-600 ">
                    <li className="mb-4">
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center ">© 2023 <a href="https://flowbite.com/" className="hover:underline">MeetNKick™</a>. All Rights Reserved.
        </span>
